...
public class pie extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                PieDataSet dataSet=new PieDataSet(barEntries,"Revenue");
                ...
                PieData barData=new PieData(daa,dataSet);
