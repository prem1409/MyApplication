...
public class scatter extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ScatterDataSet dataSet=new ScatterDataSet(Entries,"Revenue");
                ...
                ScatterData Data=new ScatterData(daa,dataSet);
